...
- **tags** — `vX.Y.Z`; the version string is identical in pyproject.toml, plugin.toml, and the catalog entry; never retag. Current release: **v1.2.7** (tagged 2026-08-28; starter-kit distribution — CDN-staged kit with in-plugin download/resume/verify (S1/T1), auto-fill import (A5), Open Run in Projects, D4 setup preflight, P1 host-dir override — replacing v1.2.6).
